public class Main {
    public static void main(String[] args) {
        ...
        Exporter pdf = new ConstrainedExporter(new BasicExporter(new PdfEncoder(), "application/pdf"), 20, "PDF");
        Exporter csv = new BasicExporter(new CsvEncoder(), "text/csv");
        Exporter json = new BasicExporter(new JsonEncoder(), "application/json");
