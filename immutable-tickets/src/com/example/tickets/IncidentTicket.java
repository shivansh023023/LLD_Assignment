...
public class IncidentTicket {
    ...
    private IncidentTicket(Builder builder) {
        ...
        this.tags = java.util.Collections.unmodifiableList(new ArrayList<>(builder.tags)); // defensive unmodifiable copy
    ...
    public List<String> getTags() { return tags; } // Safe: returns unmodifiable list
